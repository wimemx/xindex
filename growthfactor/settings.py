# Django settings for customersatisfaction project.
...
ADMINS = (
    ('Jesus Resendiz', 'jesus@wime.com.mx'),
    ('Martin Andrade', 'martin@wime.com.mx'),
)
...
SECRET_KEY = '!ad4flpskx^&amp;%3_biqb1mwqu6h+%4y=nlehdxkp5ox_r5luz+$'
