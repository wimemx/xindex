...
from xindex.models import Company, Xindex_User, Service, Question, Option, \
    Moment, Attributes, Zone, Subsidiary, BusinessUnit, Service, \
    SubsidiaryBusinessUnit, sbu_service, sbu_service_moment, \
    sbu_service_moment_attribute, Answer, Client, ClientActivity, \
    Cumulative_Report
    ...
    if has_permission(request.user, VIEW, "Ver reportes") or \
        ...
        if isinstance(subsidiary, Subsidiary):
            ...
            if isinstance(business_unit, BusinessUnit):
                ...
                print 'These are the subsidiaries'
                print subsidiary
                print 'these are the business units'
                print business_unit
        ...
        print 'This is the xindex service'
        print xindex_service
